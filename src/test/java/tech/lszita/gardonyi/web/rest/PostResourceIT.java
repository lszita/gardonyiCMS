...
import tech.lszita.gardonyi.repository.PostRepository;
import tech.lszita.gardonyi.service.dto.PostDTO;
import tech.lszita.gardonyi.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).author(DEFAULT_AUTHOR);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).author(UPDATED_AUTHOR);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).author(UPDATED_AUTHOR);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).author(UPDATED_AUTHOR);
