...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './page.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGE actions', async () => {
      const expectedActions = [
        {
